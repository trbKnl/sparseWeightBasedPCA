...
In this section we will some detailed examples where we analyze multi- and single block data with SCA and PCA, including model selection.

### Example of SCA with `sdfscads`
